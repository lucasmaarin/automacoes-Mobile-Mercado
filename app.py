...
class ProductCategorizerAgent:
    DEFAULT_CAT_SYSTEM_PROMPT = (
        ...
        "\n"
        "-- Churrasco --\n"
        "IMPORTANTE: categoria Churrasco e EXCLUSIVA para itens USADOS em um churrasco (carvao, grelha, espeto, pao de alho, tempero para carne, acendedor, etc.). "
        "NAO incluir: salgadinhos/chips com sabor churrasco, produtos defumados (salsicha defumada, linguica defumada), nem qualquer produto que apenas tenha a palavra 'churrasco' no nome sem ser um item de uso direto no churrasco.\n"
        ...
        "RaB8H9a93VNqjkFBIPmt (Kit para Churrasco): kits e acessorios para churrasco, incluindo espetos de bambu, espetos metalicos, grelhas, acendes, caixas de carvao, aventais, luvas para churrasco, telas de proteção, pegadores, garfos de churrasco e demais utensilios; EXCLUI tabacos, salgadinhos e defumados.\n"
        ...
        "\n"
        "-- Bebidas (slugs adicionais, categoria bebidas) --\n"
        "agua_de_coco (Agua de Coco/Beb): agua de coco na categoria Bebidas.\n"
        "agua_mineral (Agua Mineral/Beb): agua mineral na categoria Bebidas.\n"
        "bebidas_quentes_aperitivas (Bebidas Quentes e Aperitivas): cafe, cha quente, aperitivo quente.\n"
        "bebidas_tonicas_energeticas (Bebidas Tonicas e Energeticas): bebida tonica, energetica, Gatorade, isotonica.\n"
        "cerveja (Cerveja/Beb): cerveja em geral na categoria Bebidas.\n"
        "cha_pronto (Cha Pronto): cha pronto (Matte Leao, Lipton, Ice Tea).\n"
        "espumantes (Espumantes/Beb): espumante, champagne, prosecco.\n"
        "refrigerantes (Refrigerantes/Beb): refrigerante na categoria Bebidas.\n"
        "sucos (Sucos/Beb): suco em geral na categoria Bebidas.\n"
        "\n"
        "-- Sorvetes (categoria sorvetes) --\n"
        "kibon (Kibon): sorvetes da marca Kibon.\n"
        "nestle (Nestle): sorvetes da marca Nestle.\n"
        "vilela (Vilela): sorvetes da marca Vilela.\n"
        "sorvetes_acais_e_polpas (Sorvetes Acais e Polpas): sorvetes, acais e polpas de fruta.\n"
        "\n"
        "-- Bazar (categoria bazar) --\n"
        "automotivos (Automotivos/Bazar): produtos automotivos do bazar.\n"
        "brinquedos (Brinquedos/Bazar): brinquedos em geral do bazar.\n"
        "casa (Casa/Bazar): utensilios e produtos para casa do bazar.\n"
        "churrasco (Churrasco/Bazar): produtos de churrasco do bazar.\n"
        "descartaveis (Descartaveis/Bazar): copos, pratos e descartaveis do bazar.\n"
        "eletroportateis_e_domesticos (Eletrodomesticos/Bazar): eletrodomesticos e portateis do bazar.\n"
        "encartelados_e_ferramentas (Ferramentas Encarteladas/Bazar): ferramentas, parafusos e encartelados.\n"
        "festas (Festas/Bazar): artigos e decoracao de festa do bazar.\n"
        "jardinagem (Jardinagem/Bazar): produtos de jardinagem do bazar.\n"
        "lampadas_e_iluminacao_em_geral (Lampadas/Bazar): lampadas e iluminacao em geral.\n"
        "papelaria (Papelaria/Bazar): material escolar e de escritorio do bazar.\n"
        "textil_calcados_acessorios (Textil Calcados Acessorios/Bazar): roupas, calcados e acessorios do bazar.\n"
        "utensilios_p_cozinha (Utensilios de Cozinha/Bazar): utensilios para cozinha do bazar.\n"
        "\n"
        "-- Tabacaria (categoria tabacaria) --\n"
        "cigarro_e_fumo (Cigarro e Fumo): cigarro, fumo, tabaco, seda de cigarro, narguilé, cachimbo, palheiro.\n"
        ...
        "\n"
        "-- Uso da Loja (categoria uso_da_loja) --\n"
        "uso_interno (Uso Interno): produtos de uso interno da loja (nao para venda ao cliente).\n"
        "\n"
        "-- Ativo Imobilizado (categoria ativo_imobilizado) --\n"
        "equipamentos_eletricos (Equipamentos Eletricos): equipamentos eletricos da loja.\n"
